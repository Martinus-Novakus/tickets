...
public class ManageIndexModel : PageBase<ManageIndexModel>
{
    public ManageIndexModel(ILogger<ManageIndexModel> logger, IMediator mediator) : base(logger, mediator)
    {
    }
